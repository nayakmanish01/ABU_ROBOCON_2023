...
void loop() {
  ...
  if (Serial2.available() >= sizeof(RECEIVE_DATA_STRUCTURE)) {
  // Check if a full PS3Data struct has been received
   ...
   if(i<qsize)
   {
    ...
    PWM4 = abs(S4);
    DIR4=sgn(S4);
    // Serial.print("PWM1: "); Serial.print(PWM1);  Serial.print(" DIR1: "); Serial.println(DIR1); 
    // Serial.print("PWM2:");  Serial.print(PWM2);  Serial.print(" DIR2: "); Serial.println(DIR1);
    // Serial.print("PWM3:");  Serial.print(PWM3);  Serial.print(" DIR3: "); Serial.println(DIR1);
    // Serial.print("PWM4:");  Serial.print(PWM4);  Serial.print(" DIR4: "); Serial.println(DIR1);
